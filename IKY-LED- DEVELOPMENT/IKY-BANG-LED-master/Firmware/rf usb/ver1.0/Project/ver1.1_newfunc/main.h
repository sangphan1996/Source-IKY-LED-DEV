...
typedef enum { 
	NONE_WAKEUP_SOURCE = 0,
	BTN_PRESS_WAKEUP_SOURCE,
	RTC_WAKEUP_SOURCE
} WakeUpSource_Typedef;

#define BUTTON_PRESS_TIMEOUT		200000 //aroud 2s
#define RESET_RF_MODULE_INTERVAL	50//times sleep
// LED
...
#define ENCC_PIN                GPIO_Pin_4

#define GD0_PORT                GPIOB
#define GD0_PIN                 GPIO_Pin_4
#define GD0_EXTI                EXTI_Pin_4

#define CC2500_GDO_0_STATUS     GPIO_ReadInputDataBit(GD0_PORT, GD0_PIN)
